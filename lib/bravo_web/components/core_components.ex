defmodule BravoWeb.CoreComponents do
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        ...
        if(@kind == :info, do: "alert-info", else: ""),
        if(@kind == :error, do: "alert-error", else: "")
      ]}>
    ...
    <div class="fieldset mb-2">
      <label for={@id}>
        ...
        <select
          ...
          class={[
            @class || "w-full select",
            if(@errors != [], do: @error_class || "select-error", else: "")
          ]}
          multiple={@multiple}
          {@rest}
        >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BravoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BravoWeb.Gettext, "errors", msg, opts)
    end
  end
